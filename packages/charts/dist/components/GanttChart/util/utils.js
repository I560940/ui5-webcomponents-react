 ...
 */
export const monthsAsNumberOfDays = (startDate, endDate) => {
 ...
 */
export const yearsAsNumberOfDays = (startDate, endDate) => {
 ...
 */
export const quatersAsNumberOfDays = (startDate, endDate) => {
 ...
 */
export const prepareDaysArray = (monthsArray) => {
