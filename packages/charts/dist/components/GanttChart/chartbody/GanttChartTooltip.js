...
export const GanttChartTooltip = forwardRef(function GanttChartTooltip(_, ref) {
    ...
    return (React.createElement("div", { "data-component-name": "GanttChartTooltipContainer", className: classes.tooltipContainer, ref: divRef }, state.visible ? (React.createElement("span", { "data-component-name": "GanttChartTooltip", className: classes.tooltip, ref: popupRef, style: {
        ...
        React.createElement("span", null,
            "End:",
            state.startTime + state.duration))) : null));
});
