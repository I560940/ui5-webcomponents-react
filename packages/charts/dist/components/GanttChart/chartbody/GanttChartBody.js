...
import { GanttChartConnections } from './GanttConnections.js';
const GanttChartBody = ({
  ...
  return React.createElement(
    'div',
    { 'data-component-name': 'GanttChartBody', ref: bodyRef, className: classes.chartBody, style: style },
    React.createElement(
      GanttChartLayer,
    ...
    showConnection && displayArrows
      ? React.createElement(
          GanttChartLayer,
          { name: 'GanttChartConnectionLayer', ignoreClick: true },
          React.createElement(GanttChartConnections, {
            dataSet: dataset,
            width: width,
            rowHeight: rowHeight,
