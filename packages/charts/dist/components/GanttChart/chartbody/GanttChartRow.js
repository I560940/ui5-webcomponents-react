 ...
 */
const GanttChartRow = ({ rowData, rowHeight, rowIndex, totalDuration, timelineStart, showTooltip, hideTooltip }) => {
...
const GanttChartTask = ({
  ...
  // rendered GanttChartTask itself. The height is set to 80% to allow for an
...
GanttChartTask.displayName = 'GanttChartTask';
...
const GanttChartRowGroup = ({
  ...
  return _jsx('svg', {
    width: '100%',
    height: '100%',
    children: dataset.map((data, index) => {
      return _jsx(
        GanttChartRow,
        {
          rowData: data,
