...
import { DEFAULT_ROW_HEIGHT, DEFAULT_WIDTH, COLUMN_HEADER_HEIGHT, INVALID_DISCRETE_LABELS_MESSAGE, MOUSE_CURSOR_AUTO, MOUSE_CURSOR_GRAB, MOUSE_CURSOR_GRABBING, ROW_TITLE_WIDTH } from './util/constants.js';
 ...
 * connections.
 */
const GanttChart = forwardRef(({ dataset, totalDuration = 10, width = DEFAULT_WIDTH, rowHeight = DEFAULT_ROW_HEIGHT, isDiscrete, annotations, showAnnotation, hideTooltip, unit, rowTitle = 'Activities', columnTitle = 'Duration', discreteLabels, start = 0, valueFormat = (x) => x.toFixed(1), ...rest }, fRef) => {
    ...
    return (React.createElement("div", { ref: fRef, ...rest },
        React.createElement("div", { className: classes.main, ref: ref, style: style, "data-component-name": "GanttChart" },
            React.createElement("div", { style: { width: ROW_TITLE_WIDTH, height: height } },
                ...
                React.createElement(GanttChartRowLabels, { width: ROW_TITLE_WIDTH, height: height - COLUMN_HEADER_HEIGHT, rowHeight: rowHeight, dataset: dataset })),
            React.createElement("div", { "data-component-name": "GanttChartBodyContainer", className: classes.bodyContainer, ref: bodyConRef, style: {
                ...
                React.createElement(GanttChartBody, { dataset: dataset, width: bodyWidth, height: height - COLUMN_HEADER_HEIGHT, rowHeight: rowHeight, numOfItems: numOfRows, totalDuration: totalDuration, isDiscrete: isDiscrete, annotations: annotations, showAnnotation: showAnnotation, showTooltip: !hideTooltip, unit: unit, 
