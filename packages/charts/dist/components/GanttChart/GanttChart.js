 ...
 * connections.
 */
const GanttChart = forwardRef(({ dataset, totalDuration = 10, width = DEFAULT_WIDTH, rowHeight = DEFAULT_ROW_HEIGHT, isDiscrete, annotations, showAnnotation, showVerticalLineOnHover, showStaticVerticalLine, staticVerticalLinePosition, hideTooltip, unit, rowTitle = 'Component', columnTitle = '', discreteLabels, start = 0, valueFormat = (x) => x.toFixed(1), showStatus = true, ...rest }, fRef) => {
