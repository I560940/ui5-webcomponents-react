 ...
 */
const GanttChartAnnotation = forwardRef<HTMLDivElement, GanttChartAnnotationProps>((props, ref) => {
  ...
  return (
    <div ref={ref} className={classNames.annotation} {...rest} style={style} data-component-name="GanttChartAnnotation">
      {figure}
    </div>
  );
});
