...
import type { IGanttChartMileStone, IGanttChartRow, IGanttChartTask } from '../types/GanttChartTypes.js';
...
interface ConnectionData {
  ...
  endX: number;
  endY: number;
  connection: GanttChartConnection;
}

/**
 * This holds all the arrows that show the connections between different tasks.
 */
const GanttChartConnections = ({ dataSet, width, rowHeight, bodyRect }: GanttChartConnectionsProps) => {
...
const generateConnectionData = (
  activities: IGanttChartTask[] | IGanttChartMileStone[],
  bodyRect: DOMRect,
